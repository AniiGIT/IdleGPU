...
"""
agent/frame.py - Binary CUDA channel frame format.
...
This file is a mirror of broker/frame.py. The agent and broker are deployed
to separate machines, so each package carries its own copy.
"""
